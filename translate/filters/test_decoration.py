...
def test_isvalidaccelerator():
    ...
    assert decoration.isvalidaccelerator("a") == True
    assert decoration.isvalidaccelerator("1") == True
    assert decoration.isvalidaccelerator("ḽ") == False
    # Test new code path where we actually have an acceptlist
    assert decoration.isvalidaccelerator("a", "aeiou") == True
    assert decoration.isvalidaccelerator("ḽ", "ḓṱḽṋṅ") == True
    assert decoration.isvalidaccelerator("a", "ḓṱḽṋṅ") == False
